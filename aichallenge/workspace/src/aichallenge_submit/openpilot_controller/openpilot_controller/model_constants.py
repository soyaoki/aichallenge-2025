"""Model constants for comma.ai's driving_supercombo network.

Ported verbatim from openpilot ``openpilot/selfdrive/modeld/constants.py`` at
commit 084747c7 (MIT, comma.ai). Kept identical to upstream so that the output
slices embedded in the pinned ``driving_supercombo.onnx`` stay valid.
