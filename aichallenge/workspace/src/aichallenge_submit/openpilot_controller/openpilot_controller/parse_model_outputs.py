"""Output parser for comma.ai's driving_supercombo network.

Ported verbatim from openpilot ``openpilot/selfdrive/modeld/parse_model_outputs.py``
at commit 084747c7 (MIT, comma.ai). See ``THIRD_PARTY_NOTICES.md``.
"""
...
class Parser:
    ...
    def parse_vision_outputs(self, outs: dict) -> dict:
        self.parse_mdn('pose', outs, in_N=0, out_N=0, out_shape=(ModelConstants.POSE_WIDTH,))
        self.parse_mdn('wide_from_device_euler', outs, in_N=0, out_N=0,
                       out_shape=(ModelConstants.WIDE_FROM_DEVICE_WIDTH,))
        ...
        self.parse_categorical_crossentropy('desire_pred', outs,
                                            out_shape=(ModelConstants.DESIRE_PRED_LEN, ModelConstants.DESIRE_PRED_WIDTH))
    ...
    def parse_policy_outputs(self, outs: dict) -> dict:
        self.parse_mdn('plan', outs, in_N=0, out_N=0,
                       out_shape=(ModelConstants.IDX_N, ModelConstants.PLAN_WIDTH))
        self.parse_categorical_crossentropy('desire_state', outs, out_shape=(ModelConstants.DESIRE_PRED_WIDTH,))
        return outs

    def parse_outputs(self, outs: dict) -> dict:
